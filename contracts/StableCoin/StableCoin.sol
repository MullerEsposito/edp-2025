...
contract MullerStable is ERC20, AutomationCompatibleInterface {
    ...
    constructor() ERC20("Muller Stable", "USDMUL") {
        /**
    ...
    // 🔁 Burn MULST and withdraw ETH
    function burnAndWithdraw(uint256 burnAmount) external {
        require(balanceOf(msg.sender) >= burnAmount, "Insufficient MULST");
